; ModuleID = '/work/benchmark_sem_assertions_alinhamento_natural_v4/A_uint64_t_misaligned.bc'
source_filename = "/work/benchmark_sem_assertions_alinhamento_natural_v4/A_uint64_t_misaligned.c"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [16 x i8], ptr %buf, i64 0, i64 0, !dbg !31
  %add.ptr = getelementptr inbounds i8, ptr %arraydecay, i64 1, !dbg !32
  store ptr %add.ptr, ptr %p, align 8, !dbg !30
  call void @llvm.dbg.declare(metadata ptr %x, metadata !33, metadata !DIExpression()), !dbg !34
  %0 = load ptr, ptr %p, align 8, !dbg !35
  %1 = load i64, ptr %0, align 8, !dbg !36
  store i64 %1, ptr %x, align 8, !dbg !34
  %2 = load i64, ptr %x, align 8, !dbg !37
  ret i32 0, !dbg !38
}
...
!1 = !DIFile(filename: "/work/benchmark_sem_assertions_alinhamento_natural_v4/A_uint64_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "a27e174c937bb2b3100a4d1fa5f6812f")
!2 = !{!3}
...
!18 = !DIFile(filename: "/work/benchmark_sem_assertions_alinhamento_natural_v4/A_uint64_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "a27e174c937bb2b3100a4d1fa5f6812f")
!19 = !DISubroutineType(types: !20)
!20 = !{!21}
!21 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!22 = !{}
!23 = !DILocalVariable(name: "buf", scope: !17, file: !18, line: 5, type: !24)
...
!32 = !DILocation(line: 6, column: 35, scope: !17)
!33 = !DILocalVariable(name: "x", scope: !17, file: !18, line: 7, type: !4)
!34 = !DILocation(line: 7, column: 14, scope: !17)
!35 = !DILocation(line: 7, column: 19, scope: !17)
!36 = !DILocation(line: 7, column: 18, scope: !17)
!37 = !DILocation(line: 8, column: 11, scope: !17)
