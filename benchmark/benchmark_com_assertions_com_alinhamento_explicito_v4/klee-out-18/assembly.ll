; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/D_uint16_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/D_uint16_t_misaligned.c"
...
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/D_uint16_t_misaligned.c\00", align 1, !dbg !7
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 19, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !62
  unreachable, !dbg !62
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/D_uint16_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "f23fbf94c82c5482a5ed949b48aedc4e")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/D_uint16_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "f23fbf94c82c5482a5ed949b48aedc4e")
!20 = !{!21, !22, !28}
...
!44 = !{}
!45 = !DILocalVariable(name: "s", scope: !40, file: !2, line: 11, type: !46, align: 16)
...
!62 = !DILocation(line: 19, column: 5, scope: !40)
!63 = !DILocation(line: 20, column: 5, scope: !40)
