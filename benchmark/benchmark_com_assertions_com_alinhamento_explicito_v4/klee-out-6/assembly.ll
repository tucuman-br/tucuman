; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/B_uint16_t_aligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/B_uint16_t_aligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [81 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/B_uint16_t_aligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %add.ptr = getelementptr inbounds i8, ptr %x, i64 0, !dbg !49
  ...
  %1 = load i16, ptr %0, align 2, !dbg !53
  store i16 %1, ptr %z, align 2, !dbg !51
  %2 = load i16, ptr %z, align 2, !dbg !54
  %3 = load ptr, ptr %p, align 8, !dbg !55
  %4 = ptrtoint ptr %3 to i64, !dbg !55
  %rem = urem i64 %4, 2, !dbg !55
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/B_uint16_t_aligned.c", directory: "", checksumkind: CSK_MD5, checksum: "a3ea79b054d37f2a165259a95632e2a8")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/B_uint16_t_aligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "a3ea79b054d37f2a165259a95632e2a8")
!20 = !{!21, !27, !28}
...
!44 = !{}
!45 = !DILocalVariable(name: "x", scope: !40, file: !2, line: 6, type: !22, align: 16)
!46 = !DILocation(line: 6, column: 33, scope: !40)
