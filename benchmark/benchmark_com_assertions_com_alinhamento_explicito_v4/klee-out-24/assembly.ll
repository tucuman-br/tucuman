; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint16_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint16_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint16_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %add.ptr1 = getelementptr inbounds i8, ptr %add.ptr, i64 1, !dbg !66
  store ptr %add.ptr1, ptr %p, align 8, !dbg !61
  call void @llvm.dbg.declare(metadata ptr %z, metadata !67, metadata !DIExpression()), !dbg !68
  %1 = load ptr, ptr %p, align 8, !dbg !69
  %2 = load i16, ptr %1, align 2, !dbg !70
  store i16 %2, ptr %z, align 2, !dbg !68
  %3 = load i16, ptr %z, align 2, !dbg !71
  %4 = load ptr, ptr %p, align 8, !dbg !72
  %5 = ptrtoint ptr %4 to i64, !dbg !72
  %rem2 = urem i64 %5, 2, !dbg !72
  %cmp = icmp eq i64 %rem2, 0, !dbg !72
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !72

cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 12, ptr noundef @__PRETTY_FUNCTION__.main) #4, !dbg !72
  unreachable, !dbg !72
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @VERIFIER_nondet_uint() #0 !dbg !74 {
entry:
  %x = alloca i32, align 4
  call void @llvm.dbg.declare(metadata ptr %x, metadata !77, metadata !DIExpression()), !dbg !78
  call void @klee_make_symbolic(ptr noundef %x, i64 noundef 4, ptr noundef @.str.2), !dbg !79
  %0 = load i32, ptr %x, align 4, !dbg !80
  ret i32 %0, !dbg !81
}
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint16_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "f99911c11b746553fe19d66a89590d7e")
...
!20 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/verifier.h", directory: "", checksumkind: CSK_MD5, checksum: "067d54c60d1b3554bee88b305f379a99")
...
!25 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint16_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "f99911c11b746553fe19d66a89590d7e")
!26 = !{!27, !33}
...
!49 = !{}
!50 = !DILocalVariable(name: "buf", scope: !45, file: !2, line: 7, type: !51, align: 16)
!51 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 512, elements: !52)
!52 = !{!53}
!53 = !DISubrange(count: 64)
!54 = !DILocation(line: 7, column: 29, scope: !45)
...
!66 = !DILocation(line: 9, column: 58, scope: !45)
!67 = !DILocalVariable(name: "z", scope: !45, file: !2, line: 10, type: !28)
!68 = !DILocation(line: 10, column: 14, scope: !45)
!69 = !DILocation(line: 10, column: 19, scope: !45)
!70 = !DILocation(line: 10, column: 18, scope: !45)
!71 = !DILocation(line: 11, column: 11, scope: !45)
!72 = !DILocation(line: 12, column: 5, scope: !45)
!73 = !DILocation(line: 13, column: 5, scope: !45)
!74 = distinct !DISubprogram(name: "VERIFIER_nondet_uint", scope: !20, file: !20, line: 115, type: !75, scopeLine: 115, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24, retainedNodes: !49)
!75 = !DISubroutineType(types: !76)
!76 = !{!56}
!77 = !DILocalVariable(name: "x", scope: !74, file: !20, line: 116, type: !56)
!78 = !DILocation(line: 116, column: 22, scope: !74)
!79 = !DILocation(line: 117, column: 9, scope: !74)
!80 = !DILocation(line: 118, column: 16, scope: !74)
!81 = !DILocation(line: 118, column: 9, scope: !74)
