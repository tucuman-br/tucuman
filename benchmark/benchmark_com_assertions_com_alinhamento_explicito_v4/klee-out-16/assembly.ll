; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint64_t_aligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint64_t_aligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [81 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint64_t_aligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %arrayidx = getelementptr inbounds [8 x i64], ptr %vec, i64 0, i64 0, !dbg !50
  store ptr %arrayidx, ptr %p, align 8, !dbg !49
  call void @llvm.dbg.declare(metadata ptr %z, metadata !51, metadata !DIExpression()), !dbg !52
  %0 = load ptr, ptr %p, align 8, !dbg !53
  %1 = load i64, ptr %0, align 8, !dbg !54
  store i64 %1, ptr %z, align 8, !dbg !52
  %2 = load i64, ptr %z, align 8, !dbg !55
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 10, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !56
  unreachable, !dbg !56
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint64_t_aligned.c", directory: "", checksumkind: CSK_MD5, checksum: "ae480bf1c487b55c84444c9384b3feb9")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint64_t_aligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "ae480bf1c487b55c84444c9384b3feb9")
!20 = !{!21, !27}
...
!38 = distinct !DISubprogram(name: "main", scope: !2, file: !2, line: 5, type: !39, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !18, retainedNodes: !42)
!39 = !DISubroutineType(types: !40)
!40 = !{!41}
!41 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!42 = !{}
!43 = !DILocalVariable(name: "vec", scope: !38, file: !2, line: 6, type: !44, align: 64)
!44 = !DICompositeType(tag: DW_TAG_array_type, baseType: !22, size: 512, elements: !45)
!45 = !{!46}
!46 = !DISubrange(count: 8)
!47 = !DILocation(line: 6, column: 33, scope: !38)
!48 = !DILocalVariable(name: "p", scope: !38, file: !2, line: 7, type: !21)
!49 = !DILocation(line: 7, column: 15, scope: !38)
!50 = !DILocation(line: 7, column: 31, scope: !38)
!51 = !DILocalVariable(name: "z", scope: !38, file: !2, line: 8, type: !22)
!52 = !DILocation(line: 8, column: 14, scope: !38)
!53 = !DILocation(line: 8, column: 19, scope: !38)
!54 = !DILocation(line: 8, column: 18, scope: !38)
!55 = !DILocation(line: 9, column: 11, scope: !38)
!56 = !DILocation(line: 10, column: 5, scope: !38)
