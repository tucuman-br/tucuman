; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/F_uint16_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/F_uint16_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/F_uint16_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %z, metadata !54, metadata !DIExpression()), !dbg !57
  %0 = load ptr, ptr %p, align 8, !dbg !58
  %1 = load i16, ptr %0, align 2, !dbg !59
  %conv = zext i16 %1 to i64, !dbg !59
  store i64 %conv, ptr %z, align 8, !dbg !57
  %2 = load i64, ptr %z, align 8, !dbg !60
  %3 = load ptr, ptr %p, align 8, !dbg !61
  %4 = ptrtoint ptr %3 to i64, !dbg !61
  %rem = urem i64 %4, 2, !dbg !61
  %cmp = icmp eq i64 %rem, 0, !dbg !61
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !61

cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 10, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !61
  unreachable, !dbg !61
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/F_uint16_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "a93cc8abe0c4777bd0100fceb7f03e87")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/F_uint16_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "a93cc8abe0c4777bd0100fceb7f03e87")
!20 = !{!21, !27, !28}
...
!44 = !{}
!45 = !DILocalVariable(name: "buf", scope: !40, file: !2, line: 6, type: !46, align: 16)
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 128, elements: !47)
!47 = !{!48}
!48 = !DISubrange(count: 16)
!49 = !DILocation(line: 6, column: 29, scope: !40)
...
!54 = !DILocalVariable(name: "z", scope: !40, file: !2, line: 8, type: !55)
!55 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !23, line: 27, baseType: !56)
!56 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint64_t", file: !25, line: 45, baseType: !30)
!57 = !DILocation(line: 8, column: 14, scope: !40)
!58 = !DILocation(line: 8, column: 19, scope: !40)
!59 = !DILocation(line: 8, column: 18, scope: !40)
!60 = !DILocation(line: 9, column: 11, scope: !40)
!61 = !DILocation(line: 10, column: 5, scope: !40)
!62 = !DILocation(line: 11, column: 5, scope: !40)
