; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/A_uint64_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/A_uint64_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/A_uint64_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %arraydecay = getelementptr inbounds [16 x i8], ptr %buf, i64 0, i64 0, !dbg !50
  %add.ptr = getelementptr inbounds i8, ptr %arraydecay, i64 1, !dbg !51
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 10, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !57
  unreachable, !dbg !57
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/A_uint64_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "03798ab5d40665df0b31b984c948df1f")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/A_uint64_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "03798ab5d40665df0b31b984c948df1f")
!20 = !{!21, !27}
...
!42 = !{}
!43 = !DILocalVariable(name: "buf", scope: !38, file: !2, line: 6, type: !44, align: 64)
!44 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 128, elements: !45)
!45 = !{!46}
!46 = !DISubrange(count: 16)
!47 = !DILocation(line: 6, column: 29, scope: !38)
...
!51 = !DILocation(line: 7, column: 35, scope: !38)
!52 = !DILocalVariable(name: "z", scope: !38, file: !2, line: 8, type: !22)
!53 = !DILocation(line: 8, column: 14, scope: !38)
!54 = !DILocation(line: 8, column: 19, scope: !38)
!55 = !DILocation(line: 8, column: 18, scope: !38)
!56 = !DILocation(line: 9, column: 11, scope: !38)
!57 = !DILocation(line: 10, column: 5, scope: !38)
!58 = !DILocation(line: 11, column: 5, scope: !38)
