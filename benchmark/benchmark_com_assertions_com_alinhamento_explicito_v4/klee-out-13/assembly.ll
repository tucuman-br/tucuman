; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint16_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint16_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint16_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %vec, metadata !45, metadata !DIExpression()), !dbg !49
  call void @llvm.dbg.declare(metadata ptr %p, metadata !50, metadata !DIExpression()), !dbg !51
  %arraydecay = getelementptr inbounds [8 x i16], ptr %vec, i64 0, i64 0, !dbg !52
  ...
  %1 = load i16, ptr %0, align 2, !dbg !57
  store i16 %1, ptr %z, align 2, !dbg !55
  %2 = load i16, ptr %z, align 2, !dbg !58
  %3 = load ptr, ptr %p, align 8, !dbg !59
  %4 = ptrtoint ptr %3 to i64, !dbg !59
  %rem = urem i64 %4, 2, !dbg !59
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint16_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "2bbe63b4e2fb3b14d78a84c26f6654ec")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/C_uint16_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "2bbe63b4e2fb3b14d78a84c26f6654ec")
!20 = !{!21, !27, !28}
...
!44 = !{}
!45 = !DILocalVariable(name: "vec", scope: !40, file: !2, line: 6, type: !46, align: 16)
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !22, size: 128, elements: !47)
!47 = !{!48}
!48 = !DISubrange(count: 8)
!49 = !DILocation(line: 6, column: 33, scope: !40)
