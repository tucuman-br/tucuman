; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint64_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint64_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint64_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %2 = load i64, ptr %1, align 8, !dbg !69
  store i64 %2, ptr %z, align 8, !dbg !67
  %3 = load i64, ptr %z, align 8, !dbg !70
  %4 = load ptr, ptr %p, align 8, !dbg !71
  %5 = ptrtoint ptr %4 to i64, !dbg !71
  %rem2 = urem i64 %5, 8, !dbg !71
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint64_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "7d7978d5062392619d095e029ab8c6d1")
...
!25 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint64_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "7d7978d5062392619d095e029ab8c6d1")
!26 = !{!27, !33}
...
!48 = !{}
!49 = !DILocalVariable(name: "buf", scope: !44, file: !2, line: 7, type: !50, align: 64)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 512, elements: !51)
!51 = !{!52}
!52 = !DISubrange(count: 64)
!53 = !DILocation(line: 7, column: 29, scope: !44)
...
!65 = !DILocation(line: 9, column: 58, scope: !44)
!66 = !DILocalVariable(name: "z", scope: !44, file: !2, line: 10, type: !28)
!67 = !DILocation(line: 10, column: 14, scope: !44)
!68 = !DILocation(line: 10, column: 19, scope: !44)
!69 = !DILocation(line: 10, column: 18, scope: !44)
!70 = !DILocation(line: 11, column: 11, scope: !44)
!71 = !DILocation(line: 12, column: 5, scope: !44)
!72 = !DILocation(line: 13, column: 5, scope: !44)
!73 = distinct !DISubprogram(name: "VERIFIER_nondet_uint", scope: !20, file: !20, line: 115, type: !74, scopeLine: 115, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24, retainedNodes: !48)
!74 = !DISubroutineType(types: !75)
!75 = !{!55}
!76 = !DILocalVariable(name: "x", scope: !73, file: !20, line: 116, type: !55)
