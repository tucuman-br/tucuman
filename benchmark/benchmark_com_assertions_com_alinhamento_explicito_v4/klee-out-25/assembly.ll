; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_aligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_aligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [81 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_aligned.c\00", align 1, !dbg !7
...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %k, metadata !55, metadata !DIExpression()), !dbg !56
  ...
  store i32 %2, ptr %z, align 4, !dbg !66
  %3 = load i32, ptr %z, align 4, !dbg !69
  %4 = load ptr, ptr %p, align 8, !dbg !70
  %5 = ptrtoint ptr %4 to i64, !dbg !70
  %rem1 = urem i64 %5, 4, !dbg !70
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_aligned.c", directory: "", checksumkind: CSK_MD5, checksum: "533d2723a73baff3403fb5886cae18fc")
...
!25 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_aligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "533d2723a73baff3403fb5886cae18fc")
!26 = !{!27, !33}
...
!49 = !{}
!50 = !DILocalVariable(name: "buf", scope: !45, file: !2, line: 7, type: !51, align: 32)
...
!55 = !DILocalVariable(name: "k", scope: !45, file: !2, line: 8, type: !32)
!56 = !DILocation(line: 8, column: 18, scope: !45)
!57 = !DILocation(line: 8, column: 22, scope: !45)
!58 = !DILocation(line: 8, column: 45, scope: !45)
!59 = !DILocalVariable(name: "p", scope: !45, file: !2, line: 9, type: !27)
!60 = !DILocation(line: 9, column: 15, scope: !45)
!61 = !DILocation(line: 9, column: 31, scope: !45)
!62 = !DILocation(line: 9, column: 37, scope: !45)
!63 = !DILocation(line: 9, column: 39, scope: !45)
!64 = !DILocation(line: 9, column: 35, scope: !45)
!65 = !DILocalVariable(name: "z", scope: !45, file: !2, line: 10, type: !28)
!66 = !DILocation(line: 10, column: 14, scope: !45)
!67 = !DILocation(line: 10, column: 19, scope: !45)
!68 = !DILocation(line: 10, column: 18, scope: !45)
!69 = !DILocation(line: 11, column: 11, scope: !45)
!70 = !DILocation(line: 12, column: 5, scope: !45)
!71 = !DILocation(line: 13, column: 5, scope: !45)
!72 = distinct !DISubprogram(name: "VERIFIER_nondet_uint", scope: !20, file: !20, line: 115, type: !73, scopeLine: 115, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24, retainedNodes: !49)
!73 = !DISubroutineType(types: !74)
!74 = !{!32}
!75 = !DILocalVariable(name: "x", scope: !72, file: !20, line: 116, type: !32)
