; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [84 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %add.ptr1 = getelementptr inbounds i8, ptr %add.ptr, i64 1, !dbg !65
  store ptr %add.ptr1, ptr %p, align 8, !dbg !60
  ...
  store i32 %2, ptr %z, align 4, !dbg !67
  %3 = load i32, ptr %z, align 4, !dbg !70
  %4 = load ptr, ptr %p, align 8, !dbg !71
  %5 = ptrtoint ptr %4 to i64, !dbg !71
  %rem2 = urem i64 %5, 4, !dbg !71
  %cmp = icmp eq i64 %rem2, 0, !dbg !71
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "6dc381903fcf29d7133a417d5a01c698")
...
!25 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "6dc381903fcf29d7133a417d5a01c698")
!26 = !{!27, !33}
...
!65 = !DILocation(line: 9, column: 58, scope: !45)
...
!75 = !{!32}
!76 = !DILocalVariable(name: "x", scope: !73, file: !20, line: 116, type: !32)
