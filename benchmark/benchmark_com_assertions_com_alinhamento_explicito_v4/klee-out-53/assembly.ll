; ModuleID = '/work/benchmark_com_assertions_com_alinhamento_explicito_v4/J_uint16_t_aligned.bc'
source_filename = "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/J_uint16_t_aligned.c"
...
@.str.1 = private unnamed_addr constant [81 x i8] c"/work/benchmark_com_assertions_com_alinhamento_explicito_v4/J_uint16_t_aligned.c\00", align 1, !dbg !7
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 14, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !62
  unreachable, !dbg !62
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/J_uint16_t_aligned.c", directory: "", checksumkind: CSK_MD5, checksum: "c6560139caf32c53570384745a9423f5")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_com_alinhamento_explicito_v4/J_uint16_t_aligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "c6560139caf32c53570384745a9423f5")
!20 = !{!21, !22, !28}
...
!40 = distinct !DISubprogram(name: "main", scope: !2, file: !2, line: 8, type: !41, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !18, retainedNodes: !44)
!41 = !DISubroutineType(types: !42)
!42 = !{!43}
!43 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!44 = !{}
!45 = !DILocalVariable(name: "obj", scope: !40, file: !2, line: 9, type: !46, align: 16)
...
!49 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !46, file: !2, line: 7, baseType: !23, size: 16, offset: 16)
!50 = !DILocation(line: 9, column: 40, scope: !40)
!51 = !DILocalVariable(name: "base", scope: !40, file: !2, line: 10, type: !21)
!52 = !DILocation(line: 10, column: 11, scope: !40)
!53 = !DILocalVariable(name: "q", scope: !40, file: !2, line: 11, type: !22)
!54 = !DILocation(line: 11, column: 15, scope: !40)
!55 = !DILocation(line: 11, column: 31, scope: !40)
!56 = !DILocation(line: 11, column: 36, scope: !40)
!57 = !DILocalVariable(name: "z", scope: !40, file: !2, line: 12, type: !23)
!58 = !DILocation(line: 12, column: 14, scope: !40)
!59 = !DILocation(line: 12, column: 19, scope: !40)
!60 = !DILocation(line: 12, column: 18, scope: !40)
!61 = !DILocation(line: 13, column: 11, scope: !40)
!62 = !DILocation(line: 14, column: 5, scope: !40)
!63 = !DILocation(line: 15, column: 5, scope: !40)
