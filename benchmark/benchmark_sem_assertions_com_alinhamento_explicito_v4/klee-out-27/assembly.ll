; ModuleID = '/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.bc'
source_filename = "/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c"
...
entry:
  ...
  %add.ptr1 = getelementptr inbounds i8, ptr %add.ptr, i64 1, !dbg !46
  store ptr %add.ptr1, ptr %p, align 8, !dbg !41
  ...
  store i32 %2, ptr %z, align 4, !dbg !48
  %3 = load i32, ptr %z, align 4, !dbg !51
  ret i32 0, !dbg !52
}
...
!8 = !DIFile(filename: "/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "93199acd7064add323fe989f894f6f9c")
!9 = !{!10}
...
!26 = !DIFile(filename: "/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/E_uint32_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "93199acd7064add323fe989f894f6f9c")
...
!46 = !DILocation(line: 9, column: 58, scope: !25)
...
!55 = !{!15}
!56 = !DILocalVariable(name: "x", scope: !53, file: !2, line: 116, type: !15)
