; ModuleID = '/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/H_uint32_t_aligned.bc'
source_filename = "/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/H_uint32_t_aligned.c"
...
entry:
  ...
  %1 = load i32, ptr %0, align 4, !dbg !40
  store i32 %1, ptr %z, align 4, !dbg !38
  %2 = load i32, ptr %z, align 4, !dbg !41
  ret i32 0, !dbg !42
}
...
!1 = !DIFile(filename: "/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/H_uint32_t_aligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "8876f84480700103067bf89ed8be30b1")
!2 = !{!3}
...
!18 = !DIFile(filename: "/work/benchmark_sem_assertions_com_alinhamento_explicito_v4/H_uint32_t_aligned.c", directory: "", checksumkind: CSK_MD5, checksum: "8876f84480700103067bf89ed8be30b1")
!19 = !DISubroutineType(types: !20)
!20 = !{!21}
!21 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!22 = !{}
!23 = !DILocalVariable(name: "sp", scope: !17, file: !18, line: 12, type: !24, align: 32)
!24 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "S", file: !18, line: 5, size: 64, elements: !25)
!25 = !{!26, !28, !32}
!26 = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: !24, file: !18, line: 6, baseType: !27, size: 8)
!27 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!28 = !DIDerivedType(tag: DW_TAG_member, name: "pad", scope: !24, file: !18, line: 7, baseType: !29, size: 24, offset: 8)
!29 = !DICompositeType(tag: DW_TAG_array_type, baseType: !27, size: 24, elements: !30)
!30 = !{!31}
!31 = !DISubrange(count: 3)
!32 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !24, file: !18, line: 8, baseType: !4, size: 32, offset: 32)
!33 = !DILocation(line: 12, column: 33, scope: !17)
