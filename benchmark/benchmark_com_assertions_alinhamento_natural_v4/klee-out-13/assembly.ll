; ModuleID = '/work/benchmark_com_assertions_alinhamento_natural_v4/C_uint16_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_alinhamento_natural_v4/C_uint16_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [78 x i8] c"/work/benchmark_com_assertions_alinhamento_natural_v4/C_uint16_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %vec, metadata !44, metadata !DIExpression()), !dbg !48
  call void @llvm.dbg.declare(metadata ptr %p, metadata !49, metadata !DIExpression()), !dbg !50
  %arrayidx = getelementptr inbounds [32 x i8], ptr %vec, i64 0, i64 3, !dbg !51
  store ptr %arrayidx, ptr %p, align 8, !dbg !50
  call void @llvm.dbg.declare(metadata ptr %x, metadata !52, metadata !DIExpression()), !dbg !53
  %0 = load ptr, ptr %p, align 8, !dbg !54
  %1 = load i16, ptr %0, align 2, !dbg !55
  store i16 %1, ptr %x, align 2, !dbg !53
  %2 = load i16, ptr %x, align 2, !dbg !56
  %3 = load ptr, ptr %p, align 8, !dbg !57
  %4 = ptrtoint ptr %3 to i64, !dbg !57
  %rem = urem i64 %4, 2, !dbg !57
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/C_uint16_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "39ff4157d454d09645ed5586bd1bd9b1")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/C_uint16_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "39ff4157d454d09645ed5586bd1bd9b1")
!20 = !{!21, !27}
...
!43 = !{}
!44 = !DILocalVariable(name: "vec", scope: !39, file: !2, line: 7, type: !45)
...
!52 = !DILocalVariable(name: "x", scope: !39, file: !2, line: 9, type: !22)
!53 = !DILocation(line: 9, column: 14, scope: !39)
!54 = !DILocation(line: 9, column: 19, scope: !39)
!55 = !DILocation(line: 9, column: 18, scope: !39)
!56 = !DILocation(line: 10, column: 11, scope: !39)
!57 = !DILocation(line: 11, column: 5, scope: !39)
!58 = !DILocation(line: 12, column: 5, scope: !39)
