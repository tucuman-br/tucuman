; ModuleID = '/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint64_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint64_t_misaligned.c"
...
@.str.1 = private unnamed_addr constant [78 x i8] c"/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint64_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %s, metadata !43, metadata !DIExpression()), !dbg !48
  call void @llvm.dbg.declare(metadata ptr %p, metadata !49, metadata !DIExpression()), !dbg !50
  %b = getelementptr inbounds %struct.S, ptr %s, i32 0, i32 1, !dbg !51
  store ptr %b, ptr %p, align 8, !dbg !50
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 15, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !57
  unreachable, !dbg !57
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint64_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "cfca176dcd89fe41ddd8d576a94b8e93")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint64_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "cfca176dcd89fe41ddd8d576a94b8e93")
!20 = !{!21, !27}
...
!42 = !{}
!43 = !DILocalVariable(name: "s", scope: !38, file: !2, line: 11, type: !44)
!44 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "S", file: !2, line: 6, size: 72, elements: !45)
!45 = !{!46, !47}
!46 = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: !44, file: !2, line: 7, baseType: !4, size: 8)
!47 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !44, file: !2, line: 8, baseType: !22, size: 64, offset: 8)
!48 = !DILocation(line: 11, column: 14, scope: !38)
!49 = !DILocalVariable(name: "p", scope: !38, file: !2, line: 12, type: !21)
!50 = !DILocation(line: 12, column: 15, scope: !38)
!51 = !DILocation(line: 12, column: 33, scope: !38)
!52 = !DILocalVariable(name: "z", scope: !38, file: !2, line: 13, type: !22)
!53 = !DILocation(line: 13, column: 14, scope: !38)
!54 = !DILocation(line: 13, column: 19, scope: !38)
!55 = !DILocation(line: 13, column: 18, scope: !38)
!56 = !DILocation(line: 14, column: 11, scope: !38)
!57 = !DILocation(line: 15, column: 5, scope: !38)
