; ModuleID = '/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint32_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint32_t_misaligned.c"
...
@.str.1 = private unnamed_addr constant [78 x i8] c"/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint32_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %b = getelementptr inbounds %struct.S, ptr %s, i32 0, i32 1, !dbg !52
  store ptr %b, ptr %p, align 8, !dbg !51
  call void @llvm.dbg.declare(metadata ptr %z, metadata !53, metadata !DIExpression()), !dbg !54
  %0 = load ptr, ptr %p, align 8, !dbg !55
  %1 = load i32, ptr %0, align 4, !dbg !56
  store i32 %1, ptr %z, align 4, !dbg !54
  %2 = load i32, ptr %z, align 4, !dbg !57
  %3 = load ptr, ptr %p, align 8, !dbg !58
  %4 = ptrtoint ptr %3 to i64, !dbg !58
  %rem = urem i64 %4, 4, !dbg !58
  %cmp = icmp eq i64 %rem, 0, !dbg !58
  br i1 %cmp, label %cond.end, label %cond.false, !dbg !58

cond.false:                                       ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 15, ptr noundef @__PRETTY_FUNCTION__.main) #3, !dbg !58
  unreachable, !dbg !58
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint32_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "39c992539b7fa7b4f6b243dc10058c84")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/H_uint32_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "39c992539b7fa7b4f6b243dc10058c84")
!20 = !{!21, !27}
...
!43 = !{}
!44 = !DILocalVariable(name: "s", scope: !39, file: !2, line: 11, type: !45)
!45 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "S", file: !2, line: 6, size: 40, elements: !46)
!46 = !{!47, !48}
!47 = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: !45, file: !2, line: 7, baseType: !4, size: 8)
!48 = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: !45, file: !2, line: 8, baseType: !22, size: 32, offset: 8)
!49 = !DILocation(line: 11, column: 14, scope: !39)
!50 = !DILocalVariable(name: "p", scope: !39, file: !2, line: 12, type: !21)
!51 = !DILocation(line: 12, column: 15, scope: !39)
!52 = !DILocation(line: 12, column: 33, scope: !39)
!53 = !DILocalVariable(name: "z", scope: !39, file: !2, line: 13, type: !22)
!54 = !DILocation(line: 13, column: 14, scope: !39)
!55 = !DILocation(line: 13, column: 19, scope: !39)
!56 = !DILocation(line: 13, column: 18, scope: !39)
!57 = !DILocation(line: 14, column: 11, scope: !39)
!58 = !DILocation(line: 15, column: 5, scope: !39)
