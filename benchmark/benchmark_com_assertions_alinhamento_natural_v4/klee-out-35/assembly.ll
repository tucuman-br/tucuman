; ModuleID = '/work/benchmark_com_assertions_alinhamento_natural_v4/F_uint64_t_misaligned.bc'
source_filename = "/work/benchmark_com_assertions_alinhamento_natural_v4/F_uint64_t_misaligned.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [37 x i8] c"((uintptr_t)(p) % sizeof(*(p))) == 0\00", align 1, !dbg !0
@.str.1 = private unnamed_addr constant [78 x i8] c"/work/benchmark_com_assertions_alinhamento_natural_v4/F_uint64_t_misaligned.c\00", align 1, !dbg !7
...
entry:
  ...
  %add.ptr = getelementptr inbounds i8, ptr %arraydecay, i64 1, !dbg !52
  ...
  %1 = load i64, ptr %0, align 8, !dbg !56
  store i64 %1, ptr %z, align 8, !dbg !54
  %2 = load i64, ptr %z, align 8, !dbg !57
  %3 = load ptr, ptr %p, align 8, !dbg !58
  %4 = ptrtoint ptr %3 to i64, !dbg !58
  %rem = urem i64 %4, 8, !dbg !58
...
!2 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/F_uint64_t_misaligned.c", directory: "", checksumkind: CSK_MD5, checksum: "c8fd12b92246a67194ec9a87daeea4db")
...
!19 = !DIFile(filename: "/work/benchmark_com_assertions_alinhamento_natural_v4/F_uint64_t_misaligned.c", directory: "/home/klee", checksumkind: CSK_MD5, checksum: "c8fd12b92246a67194ec9a87daeea4db")
!20 = !{!21, !27, !28}
...
!43 = !{}
!44 = !DILocalVariable(name: "buf", scope: !39, file: !2, line: 6, type: !45)
...
!51 = !DILocation(line: 7, column: 38, scope: !39)
!52 = !DILocation(line: 7, column: 42, scope: !39)
